    ...
    <div class="card shadow p-4">
      ...
      <form method="POST" action="{{route('customer.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input name="customer_name" value="{{old('customer_name')}}" type="text" class="form-control" id="unitName" placeholder="Enter unit name">
          </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input name="email" type="email" value="{{old('email')}}" class="form-control" id="unitEmail" placeholder="Enter email address">
          </div>
        </div>
        <div class="mb-3 row">
          <label for="unitAddress" class="col-sm-2 col-form-label">Customer Address</label>
          <div class="col-sm-10">
            <input name="address" value="{{old('address')}}" type="text" class="form-control" id="unitAddress" placeholder="Enter address">
          </div>
        </div>
