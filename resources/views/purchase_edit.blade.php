...
<div class="container bg-white p-4 rounded shadow">
    ...
    <div class="row mb-3">
        ...
        <select name="supplier" class="form-select" id="supplierSelect">
            ...
            <option @selected($supplier->id == $purchase->supplier_id) value="{{$supplier->id}}">{{$supplier->supplier_name}}</option>
            @endforeach
        </select>
        </div>
        <div class="col-md-4">
            <label class="form-label">Description</label>
            <input type="text" value="{{$purchase->description}}" name="description" placeholder="Description" class="form-control desc">
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody id="purchaseBody">
            ...
            <td>
                ...
                <td><input type="number" value="{{$item->quantity}}" name="quantity[]" class="form-control qty" oninput="calcRowTotal(this)"></td>
                <td><input type="number" value="{{$item->unit_price}}" name="price[]" class="form-control price" oninput="calcRowTotal(this)"></td>
                <td><input type="number" value="{{$item->total_price}}" name="total[]" class="form-control total" readonly></td>
    ...
    <input type="submit" value="Purchase Update" class="btn btn-info">
    </form>
